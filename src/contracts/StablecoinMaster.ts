...
export class StablecoinMaster implements Contract {
  ...
  async send(
    ...
    if (
      ...
      typeof message === 'object' &&
      !(message instanceof Slice) &&
      message.$$type === 'RepayBurnNotification'
    ) {
    ...
    if (
      ...
      typeof message === 'object' &&
      !(message instanceof Slice) &&
      message.$$type === 'WithdrawFeesMessage'
    ) {
