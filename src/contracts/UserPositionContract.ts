...
function initUserPositionContract_init_args(
  src: UserPositionContract_init_args
) {
  return (builder: Builder) => {
    let b_0 = builder;
    b_0.storeAddress(src.user);
...
async function UserPositionContract_init(
  user: Address,
  stablecoinMasterAddress: Address,
  positionsManagerAddress: Address
) {
...
export class UserPositionContract implements Contract {
  static async init(
    ...
    return await UserPositionContract_init(
      user,
      stablecoinMasterAddress,
      positionsManagerAddress
    );
  ...
  static async fromInit(
    ...
    const init = await UserPositionContract_init(
      user,
      stablecoinMasterAddress,
      positionsManagerAddress
    );
  ...
  async send(
    ...
    if (
      ...
      typeof message === 'object' &&
      !(message instanceof Slice) &&
      message.$$type === 'StablecoinBurnedMessage'
    ) {
