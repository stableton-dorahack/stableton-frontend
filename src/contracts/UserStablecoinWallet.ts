...
function initUserStablecoinWallet_init_args(
  src: UserStablecoinWallet_init_args
) {
  return (builder: Builder) => {
    let b_0 = builder;
    b_0.storeAddress(src.master);
